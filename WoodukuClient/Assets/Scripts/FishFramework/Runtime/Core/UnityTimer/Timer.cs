...
namespace FishFramework
{
    ...
    public abstract class Timer
    {
        ...
        public static LoopTimer LoopAction(float interval, Action onComplete, Action<float> onUpdate,
        ...
        public static LoopTimer PersistenceLoopAction(float interval, Action onComplete, Action<float> onUpdate,
            UpdateMode updateMode, bool executeOnStart = false, Object autoDestroyOwner = null)
        {
        ...
        private static LoopTimer LoopActionInternal(bool isPersistence, float interval, Action onComplete, Action<float> onUpdate,
